...
public final class TankDrive {
    public static class Params {
        ...
        public double inPerTick = 0.02181389379;
        public double trackWidthTicks = 690.158661468671;

        // feedforward parameters (in tick units)
        public double kS = 1.799123819484782;
        public double kV = 0.003899988322600044;
